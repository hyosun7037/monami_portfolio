	...
	<div class="main__container">
		...
		<section class="about__con1">
			<div>
				...
				<button class="view__more" onclick="location.href='product.jsp' ">VIEW MORE</button>
			</div>
			<div>
		...
		<section class="about__con2">
			...
			<div class="about__con2__img">
				<a href="http://www.monamimall.com/"> <img src="images/pen1.png" />
					<p>모나미몰</p>
				</a><a href="http://www.mon-arte.com/"><p>모나르떼</p></a> <a href="http://www.monamistation.com/main.do"><p>모나미 스테이션</p></a> <a href="http://www.monami.co.kr/art_contest/contest/introduction.asp"><p>모나미 환경사랑 미술대회</p></a>
			</div>
		</section>
